...
<head>
    <header class="w3-card-8" style="background-color: #000000 ">
        <div>
            <h2 class="w3-center" style="color: #FFFFFF; display: inline; margin-left: 40%"> SERVIÇO DE ALUGUEL DE VEÍCULOS </h2>
            <button class="w3-button" style="float: right; vertical-align: top; display: inline-block" onclick="document.getElementById ('id01'). style.display = 'block'" id="loginButton"> LOGIN </button>
            <button class="w3-button" style="float: right; vertical-align: top; display: inline-block" onclick="document.getElementById ('id02'). style.display = 'block'" id="signupButton"> INSCREVA-SE </button>
        ...
        <div class="w3-modal-content w3-card-8 w3-animate-top">
            ...
            <div class="w3-container">
                <form action="autheticate.php" method="post">
                    ...
                    <input class="w3-input" name="username" type="text" obrigatório />
                    <label> Senha </label>
